...
const say = (text: string, duration = 3000): ScriptEvent => ({
	type: "say",
	text,
	duration,
});
// Helper to create simple thought
const think = (text: string, duration = 3000): ScriptEvent => ({
	type: "think",
	text,
	duration,
});
...
const HOME_SCRIPTS: SwatchyScript[] = [
	[
		think("Is that a new pixel?", 2000),
		wait(500),
		say("Welcome home! The colors missed you.", 3000),
	],
	[
		think("Everything starts here...", 2000),
		say("Ready to create something legendary?", 3000),
	],
	[
		say("Theme Token is looking good today!", 3000),
		think("Especially the border radii...", 2000),
	],
	[
		think("Scanning for creativity...", 1500),
		wait(500),
		say("High levels of inspiration detected!", 3000),
	],
	[think("I wonder what we'll build today.", 3000)],
	[say("Don't forget to check out the marketplace!", 3000)],
	[
		think("1 sat = 1 theme...", 2000),
		think("Wait, that's not right math.", 2000),
		say("Ordinals are forever!", 3000),
	],
	[
		say("Did you know you can customize me?", 3000),
		think("Please don't make me green.", 2000),
	],
	[think("Loading enthusiasm...", 1000), say("Let's go!", 2000)],
	[
		think("Looking at the blockchain...", 2000),
		say("Blocks are stacking up nicely.", 3000),
	],
];
...
const THEME_STUDIO_SCRIPTS: SwatchyScript[] = [
	...
	[
		think("Mixing colors...", 1500),
		wait(500),
		say("Ooh, that's a spicy palette!", 3000),
	],
...
const COMPONENTS_STUDIO_SCRIPTS: SwatchyScript[] = [
	...
	[
		think("Constructing interface...", 2000),
		say("Beep boop! UI complete.", 2000),
	],
	[say("ShadCN compatible, always.", 3000)],
	[
		think("Button, Card, Input...", 2000),
		say("We have all the ingredients.", 3000),
	],
	[say("Try asking for a 'pricing table'.", 3000)],
	[
		think("Compiling TypeScript...", 1500),
		say("Just kidding, I'm just a mascot.", 3000),
	],
	[say("Clean code is happy code.", 3000)],
	[
		think("I wonder if this component is responsive.", 2500),
		say("It better be!", 2000),
	],
...
const MARKET_SCRIPTS: SwatchyScript[] = [
	...
	[
		think("Checking wallet balance...", 2000),
		say("Invest in good design.", 3000),
	],
