...
function SvgPreview({ svg }: { svg: string }) {
	return (
		<div
			...
			// biome-ignore lint/security/noDangerouslySetInnerHtml: rendering trusted SVG markup generated by the icon studio
						...
						<div className="p-4 space-y-6">
							<div>
								...
								<p className="text-xs text-muted-foreground">
									Build an icon set or generate a favicon. All settings can be
									controlled by Swatchy.
								</p>
							</div>
							...
							>
								...
								<TabsContent value="icon-set" className="m-0 pt-6 space-y-5">
									...
									<div className="space-y-2">
										...
										/>
										<p className="text-[11px] text-muted-foreground">
											One name per line. The generator must fill this entire
											list.
										</p>
									</div>
								</TabsContent>
							...
							<div className="flex h-full items-center justify-center">
								<Empty>
									<EmptyHeader>
										...
										<EmptyDescription>
											Add icon names, then ask Swatchy to generate the full set
							...
							<div className="space-y-4">
								<div className="flex items-end justify-between gap-4">
									<div>
										...
										<p className="text-sm text-muted-foreground">
											{Object.keys(iconSet.generated.iconsByName).length} /{" "}
								...
								<div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6">
									{iconNames.map((name) => {
										...
										const status =
											iconSet.generated.statusByName[name] ?? "missing";
						...
						{!favicon.generated.svg ? (
							<div className="flex h-full items-center justify-center">
								<Empty>
									<EmptyHeader>
										...
										<EmptyDescription>
											Ask Swatchy to generate a favicon using your current
											settings.
										</EmptyDescription>
									</EmptyHeader>
								</Empty>
							...
							<div className="space-y-4">
								<div>
									...
									<p className="text-sm text-muted-foreground">
										SVG + PNG renditions are stored in state for
										export/inscription flows.
									</p>
								</div>
								<div className="flex items-center gap-6">
									...
									<div className="flex flex-wrap gap-3">
										{Object.entries(favicon.generated.pngBySize).map(
											([size, b64]) => (
												<div
													key={size}
													className="rounded-lg border border-border bg-card p-3"
												>
													...
													{/* biome-ignore lint/performance/noImgElement: rendering dynamically generated base64 data-URL favicons; next/image does not optimize data URLs */}
													<img
														alt={`favicon ${size}`}
