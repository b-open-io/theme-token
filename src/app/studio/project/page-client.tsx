					...
					<div className="mx-auto max-w-2xl space-y-8">
						...
						<div className="grid gap-4 sm:grid-cols-2">
							...
							<div className="rounded-lg border border-border bg-card p-4">
								...
								<div className="text-lg font-medium truncate" style={{ fontFamily: selectedFont || 'system-ui' }}>
									The quick brown fox
								</div>
							</div>
						...
						<div className="rounded-lg border border-border bg-card p-4">
							...
							<div className="grid grid-cols-3 gap-4 text-center">
								...
								<div>
									<p className="text-xs text-muted-foreground mb-1">Menu Color</p>
									<p className="text-sm font-medium capitalize">{config.menuColor}</p>
								</div>
								<div>
									<p className="text-xs text-muted-foreground mb-1">Menu Accent</p>
									<p className="text-sm font-medium capitalize">{config.menuAccent}</p>
								</div>
							</div>
						</div>
					</div>
