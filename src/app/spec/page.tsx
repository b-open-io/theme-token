...
import { Terminal, Copy, Check, Bot, FileText, Package } from "lucide-react";
          ...
          >
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              <div className="rounded-lg border border-border bg-card p-4">
                <h4 className="mb-1 font-mono text-sm font-semibold">validateThemeToken</h4>
                <p className="text-xs text-muted-foreground">Zod-powered schema validation</p>
              </div>
              <div className="rounded-lg border border-border bg-card p-4">
                <h4 className="mb-1 font-mono text-sm font-semibold">fetchThemeByOrigin</h4>
                <p className="text-xs text-muted-foreground">Fetch themes from blockchain</p>
              </div>
              <div className="rounded-lg border border-border bg-card p-4">
                <h4 className="mb-1 font-mono text-sm font-semibold">parseCss</h4>
                <p className="text-xs text-muted-foreground">Convert CSS to ThemeToken</p>
              </div>
              <div className="rounded-lg border border-border bg-card p-4">
                <h4 className="mb-1 font-mono text-sm font-semibold">applyTheme</h4>
                <p className="text-xs text-muted-foreground">Apply themes to DOM at runtime</p>
              </div>
            </div>
