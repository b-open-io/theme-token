...
// Chart data - showcases all 5 chart colors
const revenueData = [
  { month: "Jan", revenue: 4000, expenses: 2400, marketing: 1800, operations: 3200, support: 1200 },
  { month: "Feb", revenue: 3000, expenses: 1398, marketing: 2100, operations: 2800, support: 1500 },
  { month: "Mar", revenue: 9800, expenses: 2000, marketing: 3200, operations: 4100, support: 1800 },
  { month: "Apr", revenue: 3908, expenses: 2780, marketing: 2400, operations: 3500, support: 2000 },
  { month: "May", revenue: 4800, expenses: 1890, marketing: 2800, operations: 3800, support: 1600 },
  { month: "Jun", revenue: 3800, expenses: 2390, marketing: 2200, operations: 3300, support: 1400 },
];
  ...
  return (
    <Card>
      <CardHeader className="pb-2">
        ...
        <CardDescription>Monthly breakdown across all departments</CardDescription>
      </CardHeader>
      <CardContent>
      ...
      <CardContent>
        <div className="grid grid-cols-7 gap-1 text-center text-xs">
          ...
          {calendarDays.map((day, i) => (
            <div
              key={i}
              className={`p-2 rounded-md text-sm ${day === null
                  ? ""
                  : day === todayDate
