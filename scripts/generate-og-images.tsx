...
const FONT_PATH = join(
	process.cwd(),
	"public/fonts/space-grotesk-latin-700-normal.woff",
);
...
async function generatePricingOg() {
	...
	const _colors = ["#6366f1", "#c084fc", "#f472b6"];
	...
	const svg = await satori(
		<div
			style={{
				...
				backgroundImage:
					"radial-gradient(circle at 50% 0%, #1e1b4b 0%, #020617 70%)",
				position: "relative",
				fontFamily: "Space Grotesk",
			}}
		>
	...
	const svg = await satori(
		<div
			style={{
				...
				backgroundImage:
					"radial-gradient(circle at 50% 50%, #27272a 1px, transparent 1px)",
